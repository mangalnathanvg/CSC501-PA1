...
struct	pentry	{
	...
	//int 	counter;		/* Remaining ticks (quantum) */
	//int 	goodness;	 	/* Custom metric(dynamic priority) used for scheduling */
	//int 	epoch_flag;		/* Flag if process should run in current epoch */
};
